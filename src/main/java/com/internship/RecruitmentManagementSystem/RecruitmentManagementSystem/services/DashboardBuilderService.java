...
public class DashboardBuilderService implements DashboardBuilderServiceInterface {
    ...
    public  List<RecentCandidateDto> buildRecentCandidates() {
        ...
        return candidates.stream().map(this::convertor).toList();
    }
...
//    @Override
//    public  HrSummaryStatsDto buildHrSummaryStats() {
//        long totalCandidates = modelService.countCandidates();
//        long totalApplications = modelService.countApplications();
//        long totalOpenPositions = modelService.countOpenPositions();
//        long upcomingInterviewsCount = modelService.countUpcomingInterviews(LocalDate.now(),LocalTime.now());
//        long totalDegrees = modelService.countDegrees();
//        long totalSkills = modelService.countSkills();
//        long totalUniversities = modelService.countUniversities();
//        long newCandidatesToday = modelService.countNewCandidateToday();
//
//        HrSummaryStatsDto dto = new HrSummaryStatsDto();
//        dto.setTotalCandidates(totalCandidates);
//        dto.setNewCandidatesToday(newCandidatesToday);
...
//    @Override
//    public List<UniversityCountDto> buildTopUniversities() {
//        Pageable page = paginatedResponseCreator.getPageable(0,10,"universityId","desc");
//        Page<Object[]> result =
//                candidateEducationRepository.findTopUniversities(page);
////                modelService.getTopUniversities(page);
//        List<UniversityCountDto> response = new ArrayList<>();
//        for(Object[] row : result){
//            UniversityCountDto dto = new UniversityCountDto();
//            dto.setUniversity(row[0] != null ? row[0].toString() : "UNKNOWN");
...
//        LocalDateTime today = LocalDateTime.now();
//        List<Object[]> result =
////                modelService.countStatusApplicationByMonth(oneYearAgo,today,ApplicationStatus.HIRED);
//                applicationRepository.countStatusApplicationsByMonth(oneYearAgo, today,ApplicationStatus.HIRED);
//        List<MonthlyHiringStatDto> response = new ArrayList<>();
//        for(Object[] row : result){
//            int month = row[0] != null ? ((Number)row[0]).intValue() : 0;
//            long count = row[1] != null ? ((Number)row[1]).longValue() : 0L;
...
//    @Override
//    public List<PositionAnalyticsDto> buildPositionAnalytics() {
//        Pageable page = paginatedResponseCreator.getPageable(0,10,"positionId","desc");
//        Page<Object[]> result =
////                modelService.getPositionAnalysis(page);
//                positionRepository.findPositionAnalysis(page);
//        List<PositionAnalyticsDto> response = new ArrayList<>();
//        for(Object[] row : result){
//            PositionAnalyticsDto dto = new PositionAnalyticsDto();
//            Integer positionId = row[0] != null ? ((Number)row[0]).intValue() : null;
...
//    public RecruitmentFunnelStatDto buildRecruitmentFunnelStat() {
//        RecruitmentFunnelStatDto dto = new RecruitmentFunnelStatDto();
//        long totalApplication = modelService.countApplications();
//        long shortListed = modelService.countShortlistedApplications();
//        long selected = modelService.countApplicationByStatus(ApplicationStatus.HIRED);
//
//        dto.setApplications(totalApplication);
//        dto.setShortlisted(shortListed);
//        dto.setSelected(selected);
...
//    @Override
//    public  List<DegreeCountDto> buildTopDegrees() {
//        Pageable page = paginatedResponseCreator.getPageable(0,10,"degreeId","desc");
//        Page<Object[]> result = modelService.getTopDegrees(page);
//        List<DegreeCountDto> response = new ArrayList<>();
//        for(Object[] row : result){
//            DegreeCountDto dto = new DegreeCountDto();
//            dto.setDegree(row[0] != null ? row[0].toString() : "UNKNOWN");
...
////                modelService.countInterviewByStatus();
//                interviewRepository.countInterviewsByStatus();
//
//        List<InterviewOutcomeStatDto> result = new ArrayList<>();
//        Map<InterviewStatus, Long> statusCountMap = response.stream().collect(
//                Collectors.toMap(
...
//        long totalUsers = userRepository.count();
//        long totalRequests = registerRepository.count();
//        long upcomingInterviewsCount = modelService.countUpcomingInterviews(today, currentTime);
//        long totalOpenPositions = positionRepository.countActivePosition();
//        long totalUniversities = universityRepository.count();
//        long totalSkills = skillRepository.count();
//        long totalDegrees = degreeRepository.count();
